...
R:(1+til count R)!R:get each read0 `wmates.txt
6 4 5 2 3 1~value first srs:.match.srp R
...
R:(1+til count R)!R:get each read0 `mates.txt
4 3 2 1 7 8 5 6~value first srs:.match.srp R
