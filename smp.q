...
.util.assert[key[M]!e] first eSR:.matching.smp[M;F]

/ there is only one stable match and it is optimal for M and F
.util.assert[key eSR 0] value asc first .matching.smp[F;M]
